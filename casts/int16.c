...
PG_FUNCTION_INFO_V1(int2_from_int4);
Datum int2_from_int4(PG_FUNCTION_ARGS) {
...
PG_FUNCTION_INFO_V1(int2_from_int16);
Datum int2_from_int16(PG_FUNCTION_ARGS) {
...
PG_FUNCTION_INFO_V1(int2_from_uint2);
Datum int2_from_uint2(PG_FUNCTION_ARGS) {
...
PG_FUNCTION_INFO_V1(int2_from_uint8);
Datum int2_from_uint8(PG_FUNCTION_ARGS) {
