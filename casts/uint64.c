...
PG_FUNCTION_INFO_V1(uint8_from_uint4);
Datum uint8_from_uint4(PG_FUNCTION_ARGS) {
...
PG_FUNCTION_INFO_V1(uint8_from_int16);
Datum uint8_from_int16(PG_FUNCTION_ARGS) {
